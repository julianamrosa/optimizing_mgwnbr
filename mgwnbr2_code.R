mgwnbr2 <- function(DATA, YVAR, XVAR, WEIGHT=NULL, LAT, LONG,
  ...
  if (toupper(MGWR)!="YES"){
    ...
    names(band) <<- c("Intercept", c("PctBlack", "PctFB", "TotPop90", "PctEld"), "socf") #flag otim
    rownames(band) <<- NULL
  ...
  if (toupper(MODEL)=='NEGBIN'){
    ENP <- c(ENP, (v1/nvarg))
    names(ENP) <- c('Intercept', c("PctBlack", "PctFB", "TotPop90", "PctEld"), 'MGWR', 'GWR', 'alpha') #flag otim
  }
  else{
    names(ENP) <- c('Intercept', c("PctBlack", "PctFB", "TotPop90", "PctEld"), 'MGWR', 'GWR') #flag otim
  }
  ...
  if (toupper(MODEL)=='NEGBIN'){
    colnames(qntl) <- c('Intercept', c("PctBlack", "PctFB", "TotPop90", "PctEld"), 'alpha') #flag otim
  }
  else{
    colnames(qntl) <- c('Intercept', c("PctBlack", "PctFB", "TotPop90", "PctEld")) #flag otim
  }
  ...
  if (toupper(MODEL)=='NEGBIN'){
    colnames(descriptb) <- c('Intercept', c("PctBlack", "PctFB", "TotPop90", "PctEld"), 'alpha') #flag otim
  }
  else{
    colnames(descriptb) <- c('Intercept', c("PctBlack", "PctFB", "TotPop90", "PctEld")) #flag otim
  }
  ...
  if (toupper(MODEL)=='NEGBIN'){
    colnames(qntls) <- c('Intercept', c("PctBlack", "PctFB", "TotPop90", "PctEld"), 'alpha') #flag otim
  }
  else{
    colnames(qntls) <- c('Intercept', c("PctBlack", "PctFB", "TotPop90", "PctEld")) #flag otim
  }
  ...
  if (toupper(MODEL)=='NEGBIN'){
    colnames(descripts) <- c('Intercept', c("PctBlack", "PctFB", "TotPop90", "PctEld"), 'alpha') #flag otim
  }
  else{
    colnames(descripts) <- c('Intercept', c("PctBlack", "PctFB", "TotPop90", "PctEld")) #flag otim
  }
  ...
  if (toupper(MODEL)=='NEGBIN'){
    rownames(bg_stdg_tg_probtg) <- c('Intercept', c("PctBlack", "PctFB", "TotPop90", "PctEld"), 'alpha') #flag otim
  }
  else{
    rownames(bg_stdg_tg_probtg) <- c('Intercept', c("PctBlack", "PctFB", "TotPop90", "PctEld")) #flag otim
  }
  ...
  colname1 <- c("Intercept", c("PctBlack", "PctFB", "TotPop90", "PctEld"))
